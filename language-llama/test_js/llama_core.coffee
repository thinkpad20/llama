...
class LlamaObject
  constructor: (@type, @constr_name, @values=[], @attrs={}, @parent, affect) ->
...
_.extend exports, {
  LlamaObject, Exception, LookupError, PatternMatchError, print,
  ConstructorNotFoundError, NoAttributeError, _throw, show, println,
  _plus, _minus, _times, _divide, _append, _f_apply, _apply, _f_comp,
  _comp, str_or_array_to_list, Show, Trait, Just, Nothing, TVar, TConst,
  TApply, TFunction, TWildCard, Default, _default, End, Cons
}
